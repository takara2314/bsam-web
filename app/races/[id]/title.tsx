...
const Title = ({ raceName, assocName }: Props) => {
  return (
    <section className="w-full flex flex-row gap-4">
      ...
      <div className="w-[calc(100%-3rem)] wrap-break-word">
        <h1 className="mb-2 text-base 2xl:text-xl font-medium">{raceName}</h1>
        <h2 className="text-gray-500 text-sm 2xl:text-base">{assocName}</h2>
      </div>
    </section>
  );
};
